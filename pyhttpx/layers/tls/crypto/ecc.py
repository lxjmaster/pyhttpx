...
class ECDHE:
    ...
    def __init__(self, curvename):
        ...
        self.client_kx_privkey = ec.generate_private_key(
            self.curve, backend=default_backend()
        )
    ...
    def create(self):
        ...
        # 生成固定私钥
        client_kx_privkey = ec.derive_private_key(
            private, self.curve, default_backend()
        )
    ...
    def test(self):
        ...
        server_publickey = ec.EllipticCurvePublicKey.from_encoded_point(
            self.curve, sever_publickey_bytes
        )
